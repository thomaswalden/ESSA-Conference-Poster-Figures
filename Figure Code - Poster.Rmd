 ...
 sRPEPLOT <- ggplot(sRPEmeans,aes(x=session_f, y=sRPE))+
    ...
    theme_bw()+
     ...
     #scale_fill_manual(name = "session_f",
                            #labels = session_f.labs,
                            #values = c("lightpink1", "pink3", "grey", "red1"))+
...
```{r}
ggsave(plot=SUBFIG,"C:\\Users\\thoma\\OneDrive - Murdoch University\\Desktop\\PhD 2020\\Conferences\\ESSA\\WALK STUDY\\SUBFIG(ESSA Poster).png",units = "in",width = 15.0,height = 10.0)
```
