...
```{r}
ggsave(plot=SUBFIGdots,"C:\\Users\\thoma\\OneDrive - Murdoch University\\Desktop\\PhD 2020\\Conferences\\ESSA\\WALK STUDY\\SUBFIG-COLOUR(ESSA Poster)dots3.png",units = "in",width = 15.0,height = 9.0)
```
