...
SUMVEplot<-ggplot(SUMVE, aes(x = workingdata_f, y = VE, colour= session_f)) +
          ...
          geom_point(aes(shape = session_f, colour = session_f),fill = "white", size = 6, stroke = 1.0, position= pd)+
          
        scale_colour_manual(name = "session_f",
                            labels = session_f.labs,
                            values = c("#F06292", "#E91E63", "#F44336", "#C62828"))+
...
```{r}
ggsave(plot=SUMVEplot,"C:\\Users\\thoma\\OneDrive - Murdoch University\\Desktop\\PhD 2020\\Conferences\\ESSA\\WALK STUDY\\VE(ESSA Poster-Colour)2.png",units = "in",width = 15.0,height = 9.0)
```
...
chp1HRplot<-ggplot(SUMchp1hr, aes(x = workingdata_f, y = HR..bpm., colour= session_f)) +
          ...
          geom_point(aes(shape = session_f), fill = "white", size = 6, stroke = 1.0, position= pd)+
                  scale_colour_manual(name = "session_f",
                            labels = session_f.labs,
                            values = c("#F06292", "#E91E63", "#F44336", "#C62828"))+
                  scale_shape_manual(name = "session_f",
...
```{r}
ggsave(plot=chp1HRplot,"C:\\Users\\thoma\\OneDrive - Murdoch University\\Desktop\\PhD 2020\\Conferences\\ESSA\\WALK STUDY\\HR(ESSA Poster-Colour)2.png",units = "in",width = 15.0,height = 9)
```
