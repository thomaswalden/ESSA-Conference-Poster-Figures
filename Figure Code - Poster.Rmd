...
```{r}
ggsave(plot=SUMVEplot,"C:\\Users\\thoma\\OneDrive - Murdoch University\\Desktop\\PhD 2020\\Conferences\\ESSA\\WALK STUDY\\VE(ESSA Poster).png",units = "in",width = 15.0,height = 9.0)
```
...
```{r}
ggsave(plot=chp1HRplot,"C:\\Users\\thoma\\OneDrive - Murdoch University\\Desktop\\PhD 2020\\Conferences\\ESSA\\WALK STUDY\\HR(ESSA Poster).png",units = "in",width = 15.0,height = 9)
```
